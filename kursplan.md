...
|28.01 | 4 | Skriveverksted <br> 1. Quarto <br> 2. Veiledningsassistenten <br> 3. Struktur på oppgaven <br> 4. Mal for førstesiden (Erlend S: Øverli)| [Quarto eksempel](/bruk_quarto_2209_V24.qmd) <br> [eksempel.bib](/eksempel.bib) <br> [norsk.yml](/norsk.yml) <br> [apa.csl](/apa.csl) <br> [bilde fra jupyter](/Screenshot.png) <br> [AI som assistent (slides)](/veiledningsprompt.html) <br > [Assistentprompten](/assistentprompten.pdf) <br> [Konvertering av .json til .txt](/import_%20json.py) <br> [Generisk struktur](/Struktur_bacheloroppgave.pdf) <br> [Erlends mal](/mal)|
...
|04.02| 6 | Statistikk - noen tips til estimering         |    |

...
|21.02 | 7 | Skriveverksted - Quarto| [Quarto eksempel](/forelesninger/bruk_quarto.qmd) <br> [eksempel.bib](/forelesninger/eksempel.bib) <br> [norsk.yml](/forelesninger/norsk.yml) <br> [apa.csl](/forelesninger/apa.csl) <br > [Assistentprompten](/assistentprompten.pdf) <br> [Konvertering av .json til .txt](/import_ json.py) |
